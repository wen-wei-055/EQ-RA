...
if __name__ == '__main__':
    ...
    train_district_PGA_event_idx = json.load(open(training_params['train_district_PGA_event_idx'],'r'))
    val_district_PGA_event_idx = json.load(open(training_params['val_district_PGA_event_idx'],'r'))
    ...
    for ens_id in [0]:
        ...
        train_retrieve_event = None
        val_retrieve_event = None
        if args.experiment_retrieve_event:
            train_retrieve_event = json.load(open(training_params['train_retrieve_event'],'r'))
            val_retrieve_event = json.load(open(training_params['val_retrieve_event'],'r'))
        ...
        for i, generator_param_set in enumerate(generator_params): 
            ...
            train_datas += [util.PreloadedEventGenerator(datapath=training_params['train_data_path'],
                                                        retrieve_event=train_retrieve_event,
                                                        experiment_retrieve=args.experiment_retrieve_event,
                                                        RAG_topK=training_params['RAG_topK'],
                                                        ...
                                                        district_PGA_event_idx=train_district_PGA_event_idx,
                                                        **generator_param_set)]
            ...
            val_datas += [util.PreloadedEventGenerator(datapath=training_params['val_data_path'],
                                                       retrieve_event=val_retrieve_event,
                                                       experiment_retrieve=args.experiment_retrieve_event,
                                                       RAG_topK=training_params['RAG_topK'],
                                                       total_datapath=training_params['total_data_path'],
                                                       datatype='Val',
                                                       ...
                                                       first_appearance_list=first_appearance_list,
                                                       last_appearance_list=last_appearance_list,
                                                       district_PGA_event_idx=val_district_PGA_event_idx,
                                                       **generator_param_set)]
        ...
        for epoch in range(num_epochs):
            ...
            if epoch < record_epoch:
                ...
                after_50_min = min(val_loss_record[record_epoch-1:-1])
                    
            if epoch%9==0 or (epoch>record_epoch-1 and epoch<record_epoch+11) or val_loss_record[-1]<after_50_min: 
